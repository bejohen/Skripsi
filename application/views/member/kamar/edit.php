    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <!-- PAGE CONTENT BEGINS -->
                    <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url().'admin/kamar/doEdit/'.$this->uri->segment(4); ?>" role="form"> 
                       <?php 
                       ...
                       echo $this->session->flashdata('msgbox');?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="col-xs-10 col-sm-5" id="form-field-1-1" placeholder="Isi nama kamar" id='kamar' value="<?php echo $dataDetail['nama_kamar']; ?>" name="txtKamar" />
                            </div>
                        </div>
                            ...
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Tipe Kamar</label>
                             <div class="col-sm-9">
                                <select name="txtTipeKamar" class="col-xs-10 col-sm-5">
                                    <option value="<?php echo $dataDetail['id_tipekamar'] ?>"><?php echo $dataDetail['tipekamar'] ?></option>  
                                    <option>Pilih</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="col-xs-10 col-sm-5" id="form-field-1-1" placeholder="Isi jumlah" id='jumlah' value="<?php echo $dataDetail['jumlah_kamar']; ?>" name="txtJumlah" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="col-xs-10 col-sm-5" id="form-field-1-1" placeholder="Isi lantai" id='ruangan awal' value="<?php echo $dataDetail['lantai_kamar']; ?>" name="txtLantai" />
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="col-xs-10 col-sm-5 nominal" id="form-field-1-1" placeholder="Rp. 000,000,000.00"  name="txtHarga" value="<?php echo number_format($dataDetail['harga'],2,'.',','); ?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="col-xs-10 col-sm-5" id="form-field-1-1" placeholder="Isi deskripsi kamar" id='deskripsi' value="<?php echo $dataDetail['deskripsi']; ?>" name="txtDeskripsi" />
                            </div>
                        </div>
