...
<html lang="en">
    <head>
        ...
        <!-- ace styles -->
        <link rel="stylesheet" href="<?php echo ASSET_SAYA ?>css/ace.css" />

        <!--[if lte IE 9]>
                <link rel="stylesheet" href="../assets/css/ace-part2.css" />
        <![endif]-->
        <link rel="stylesheet" href="<?php echo ASSET_SAYA ?>css/ace-rtl.css" />
                        ...
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    ...
                                    <span class="red">Sun City</span>
                                </h1>
                                <h4 class="blue" id="id-company-text">Copyright &copy; 2018 Sun City</h4>
                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <div class="alert alert-danger">
                                                <strong>ERROR!</strong> Username or password, please try again
                                            </div>
                                            <?php } ?>
