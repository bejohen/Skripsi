            ...
            <div class="page-header">
                <h1>
                    ...
                    <small>
                        ...
                        Data semua pembayaran yang sudah diverifikasi
                    </small>
                </h1>
            </div><!-- /.page-header -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="table-header">
                                Menampilkan seluruh data pembayaran yang sudah dikonfirmasi
                            </div>
                                ...
                                $no++;
                                 ?>
                                  <tr>
                                    ...
                                    <td>
									<?php 
									if($value['status_konfirmasipembayaran'] == "2"){
										echo "Paid";
									}elseif($value['status_konfirmasipembayaran'] == "3"){
										echo "Invalid";
									}else{
										echo "Spam";
									}
									?></td>
									<td><a style="color:red;" target="_blank" href="<?php echo base_url().'reservasi/download/'.$value['id_reservasi'] ?>">Cetak</a></td>
                                </tr>
                                <?php 
                                }
                                ?>   
